 ...
 *
 * Vive en el inicio, junto al resto del resumen: tener esto en una pantalla
 * aparte obligaba a ir a buscarlo, y es justo el tipo de dato que solo sirve si
 * se ve de pasada.
 *
 * Todo se calcula a partir de las prendas que ya están en el espejo: no hay
  ...
  if (inv.conPrecio === 0) {
    return (
      <section className="edge rounded-[1.5rem] bg-surface p-5">
        <h2 className="font-display text-lg leading-tight">Todavía no hay precios</h2>
        <p className="mt-1.5 text-sm leading-relaxed text-ink-muted">
          Anota el precio aproximado al catalogar una prenda, o edítalo después, y aquí verás
          cuánto llevas invertido y en qué.
        </p>
        <Link
